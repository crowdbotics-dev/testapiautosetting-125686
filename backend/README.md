...
## Project Structure
    ...
    ├── testapiautosetting_125686  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125686`
...
2. Clone this repo and `cd testapiautosetting_125686`
